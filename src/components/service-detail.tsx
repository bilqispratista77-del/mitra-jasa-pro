            ...
            >
              ...
              {isMember ? (
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-gray-400 px-5 py-3.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-gray-500 hover:shadow-md active:scale-[0.98]"
                >
                  <Lock className="h-5 w-5" />
                  Daftar Member untuk Menghubungi
                </button>
              )}
            </motion.div>
